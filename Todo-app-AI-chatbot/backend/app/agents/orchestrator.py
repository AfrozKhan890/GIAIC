...
class AgentOrchestrator:
    ...
    def run_chat(self, history: List[Dict[str, Any]], user_message: str) -> str:
        ...
        while iteration < max_iterations:
            ...
            try:
                # Safely extract first candidate and part
                ...
                # If we get here, no text or function_call found
                print(f"[AGENT] Warning: Response has no text or function_call")
                return "I processed your request, but I'm not sure how to respond. Please try again."

            except Exception as e:
                print(f"[AGENT] Error processing response: {e}")
                return "I apologize, but I encountered an error processing your request. Please try again."

        # Max iterations reached
        return "I apologize, but I'm having trouble completing this request. Please try rephrasing."
