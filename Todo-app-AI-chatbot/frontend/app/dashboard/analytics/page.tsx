    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">{analyticsData.overview.totalTasks}</div>
                  ...
                  <div key={day} className="flex-1 flex flex-col items-center gap-1">
                    <div className="w-full flex flex-col items-center gap-1">
                      <div 
                        ...
                        style={{ height: `${analyticsData.weekly.completed[index] * 20}px` }}
                      />
                      <div 
                        className="w-3/4 bg-muted-foreground/30 rounded-t"
                        style={{ height: `${analyticsData.weekly.created[index] * 20}px` }}
                      />
                    </div>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="font-semibold">Productivity Trend</h4>
              </div>
